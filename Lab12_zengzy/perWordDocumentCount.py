...
def flatMapFunc(document):
    ...
    """
    documentID = document[0] # 10 index
    # print('AbaAba!',document[1]) # 10 lines of words
    # words=[]
    # for i in range(10):
    words = re.findall(r"\w+", document[1])
    words=list(set(words)) # modification is here!
    # print('AbaAba!',words)# separate by words
    return words
