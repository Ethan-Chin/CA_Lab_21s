...
## %bb.0:
	...
	movl	%edi, -400(%rbp)
	movq	%rsi, -408(%rbp)
	movq	l___const.main.A(%rip), %rdx
	movq	%rdx, -48(%rbp)
	movq	l___const.main.A+8(%rip), %rdx
	movq	%rdx, -40(%rbp)
	movq	l___const.main.A+16(%rip), %rdx
	movq	%rdx, -32(%rbp)
	movq	l___const.main.A+24(%rip), %rdx
	movq	%rdx, -24(%rbp)
	movq	l___const.main.B(%rip), %rdx
	movq	%rdx, -80(%rbp)
	movq	l___const.main.B+8(%rip), %rdx
	movq	%rdx, -72(%rbp)
	movq	l___const.main.B+16(%rip), %rdx
	movq	%rdx, -64(%rbp)
	movq	l___const.main.B+24(%rip), %rdx
	movq	%rdx, -56(%rbp)
	movq	%rax, %rdx
	movq	%rdx, %rdi
	movl	%ecx, %esi
	...
	movq	%rax, -120(%rbp)
	movq	-120(%rbp), %rax
	movupd	(%rax), %xmm0	# __m128d c1 = _mm_loadu_pd( C+2 )
	movapd	%xmm0, -448(%rbp)
	movl	$0, -452(%rbp)
	
	
	# 'LBB0_1' is the for loop
...
## %bb.2:                               ##   in Loop: Header=BB0_1 Depth=1
	...
	movddup	%xmm0, %xmm0	# __m128d b1 = _mm_load1_pd( B+0+i );	## xmm0 = xmm0[0,0]
	movapd	%xmm0, -160(%rbp)
	movapd	-160(%rbp), %xmm0
	movapd	%xmm0, -496(%rbp)
	movslq	-452(%rbp), %rcx
	...
	movddup	%xmm0, %xmm0	# __m128d b2 = _mm_load1_pd( B+2+i ); ## xmm0 = xmm0[0,0]
	movapd	%xmm0, -192(%rbp)
	movapd	-192(%rbp), %xmm0
	movapd	%xmm0, -512(%rbp)
	movapd	-432(%rbp), %xmm0
	...
	movapd	%xmm1, -320(%rbp)
	movapd	-304(%rbp), %xmm0
	addpd	-320(%rbp), %xmm0	# c2 = _mm_add_pd( c2, _mm_mul_pd( a, b2 ) );
	movapd	%xmm0, -448(%rbp)
